  ...
  return (
    <div className="slideshow">
      <figure>
        ...
        <figcaption>
          <h3>Garburator Project</h3>
          <div className="row open-sans-font">
            <div className="col-12 col-sm-6 mb-2">
              <i className="fa fa-file-text-o pr-2"></i>
              <span className="project-label">Project </span>:{" "}
              <span className="ft-wt-600 uppercase">Garburator</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Java, Kotlin</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <a
                  ...
                  rel="noreferrer"
                >
                  https://www.samsung.com/Garburator
              </a>
              </span>
            </div>
            {/* End .col */}
        ...
        <Slider {...settings}>
          ...
          <div className="slide_item">
            <img src="img/projects/project-2.1.jpg" alt="slide 2" />
          </div>
          <div className="slide_item">
